...
//                    // añadir
//                    // Elegir posicion
//                    DialogTablero dialogSeleccion = new DialogTablero(vista, this.dimsTableroPrevias);
//                    dialogSeleccion.setVisible(true);
//                    Point seleccion = dialogSeleccion.obtenerPunto();
//                    if (seleccion != null) {
//                        try {
//                            Class clasePieza = Class.forName("caminoeuleriano.Modelo.piezas." + inputName);
//                            Pieza instancia;
//                            // Si tiene constructor con parámetro lo llamamos, si no 
//                            // llamamos al que no los tiene
//                            try {
//                                instancia = (Pieza) clasePieza.getConstructor(int.class).newInstance(this.dimsTableroPrevias);
